...
def create_nails_label_colormap():
  """Creates a label colormap used in PASCAL VOC segmentation benchmark.

  Returns:
    A colormap for visualizing segmentation results.
  """
  colormap = np.zeros((_DATASET_MAX_ENTRIES[_NAILS], 3), dtype=int)
  ind = np.arange(_DATASET_MAX_ENTRIES[_NAILS], dtype=int)
...
def create_label_colormap(dataset=_PASCAL):
  ...
  if dataset == _ADE20K:
    ...
    return create_nails_label_colormap()
  else:
